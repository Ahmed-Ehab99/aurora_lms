...
const NotFoundPage = () => {
  return (
    <div className="bg-background fixed inset-0 z-900 flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 py-16">
      ...
      <div className="fade-in-up relative z-10 flex flex-col items-center space-y-8 text-center">
        ...
        >
          <h2 className="text-foreground text-2xl font-semibold tracking-tight md:text-3xl">
            Hmm, seems that this course is broken 🤔
          </h2>
          <p className="text-muted-foreground max-w-md text-lg md:text-xl">
            Something wrong with this course! We are working on it. Please come
            back later
          </p>
        </div>
