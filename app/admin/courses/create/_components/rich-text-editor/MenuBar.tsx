...
// const MenuBar = ({ editor }: MenuBarProps) => {
//   // useEditorState only re-renders when the editor state actually changes
//   const editorState = useEditorState({
//     editor,
//     selector: (ctx) => {
//       if (!ctx.editor)
...
//               <Toggle
//                 size="sm"
//                 data-state={editorState.isH1 ? "on" : "off"}
...
//               <Toggle
//                 size="sm"
//                 data-state={editorState.isH2 ? "on" : "off"}
...
//               <Toggle
//                 size="sm"
//                 data-state={editorState.isH3 ? "on" : "off"}
...
//               <Toggle
//                 size="sm"
//                 data-state={editorState.isH4 ? "on" : "off"}
...
//               <Toggle
//                 size="sm"
//                 data-state={editorState.isH5 ? "on" : "off"}
...
//               <Toggle
//                 size="sm"
//                 data-state={editorState.isH6 ? "on" : "off"}
...
//               <Toggle
//                 size="sm"
//                 data-state={editorState.isAlignLeft ? "on" : "off"}
...
//               <Toggle
//                 size="sm"
//                 data-state={editorState.isAlignCenter ? "on" : "off"}
...
//               <Toggle
//                 size="sm"
//                 data-state={editorState.isAlignRight ? "on" : "off"}
